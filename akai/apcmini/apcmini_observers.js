...
function init_observers() {
  ...
  var scenes = trackbank.getClipLauncherScenes();
  scenes.addNameObserver( scene_name_observer() );
  
  //for (var sc=0; sc<NUM_SCENES; sc++) {
  //  var scene = scenebank.getScene(sc);
  //}
...
function trackbank_channelcount_observer() {
  return function(value) {
    //println("trackbank_channelcount_observer: " + value);
...
function trackbank_scenecount_observer() {
  return function(value) {
    //println("trackbank_scenecount_observer: " + value);
...
function trackbank_scenescrollposition_observer() {
  return function(value) {
    ...
    //println("trackbank_scenescrollposition_observer: " + value);
...
function trackbank_trackscrollposition_observer() {
  return function(value) {
    ...
    //println("trackbank_trackscrollposition_observer: " + value);
    //page_update(UPDATE_GRID);
  }
}
...
function scene_name_observer() {
  return function(index,value) {
    //println("scene_name_observer(" + index + "," + name + ")");
    scene_name[index] = value;
    //page_update(UPDATE_SCENE,index);
  }
}

function scene_position_observer(sc) {
  return function(value) {
    scene_position[sc] = value;
    //println("scene_position_observer(" + sc + "," + value + ")");
    //page_update(UPDATE_TRACK,tr);
    //println("scene " + sc + " position " + value);
  }
}
